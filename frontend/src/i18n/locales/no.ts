...
export const Norwegian: LanguageSchema = {
  translation: {
    ...
    errorWhileFetchingUpdatedAtFromLatestUserForm:
      'Feil ved henting av updatedAt fra siste UserForm',
    login: {
    ...
    createAccount: {
      ...
      yourCodeIsOnTheWay:
        'Koden din er på vei. For å logge inn, skriv koden vi sendte til',
    ...
    myAnswers: {
      ...
      itHasBeenTimeSinceTheBlockWasUpdated:
        'Det har gått {{time}} siden blokken ble oppdatert!',
    ...
    admin: {
      ...
      editGroups: {
        ...
        areYouSureYouWantToRemoveTheGroup:
          'Er du sikker på at du har lyst til å fjerne gruppen?',
        members: 'Medlemmer',
        details: 'Detaljer',
      ...
      editCatalogs: {
        description:
          'På denne siden kan du lage nye kataloger, fjerne kataloger og endre på eksisterende kataloger, kategorier og spørsmål.',
        ...
        areYouSureYouWantToRemoveThisCatalog:
          'Er du sikker på at du har lyst til å fjerne denne katalogen? Dette vil ikke slette svarene til de ansatte, men gjør det vanskelig å koble svar opp mot spørsmålsett.',
        nameOfNewCatalog: 'Navnet på den nye katalogen',
        areYouSureYouWantToActivateThisCatalog:
          'Er du sikker på at du har lyst til å bruke denne katalogen? Dette vil endre spørsmålsettet de ansatte svarer på.',
        catalogs: 'Kataloger',
        modify: 'Endre',
        addNewCategory: 'Legg til ny kategori',
        nameOfNewCategory: 'Navn på ny kategori',
        nameOfTheCategoryCantBeEmpty:
        ...
        areYouSureYouWantToDeleteThisQuestion:
          'Er du sikker på at du har lyst til å fjerne dette spørsmålet? Denne handlingen kan ikke angres. Svar på dette spørsmålet kan da ikke kobles opp mot spørsmålet som ble svart på.',
        ...
        noCategoriesInThisCatalogYet:
          'Ingen kategorier i denne katalogen ennå.',
    ...
    superAdmin: {
      ...
      editOrganizations: {
        ...
        areYouSureYouWantToRemoveTheOrganization:
          "Er du sikker på at du har lyst til å fjerne organisasjonen '{{organization}}'?",
      ...
      editSuperAdministrators: {
        description:
          'På denne siden kan du legge til og fjerne super-administratorer.',
    ...
    adminApi: {
      ...
      error: {
        couldNotRemoveUserFromGroup:
          "Kunne ikke fjerne brukeren '{{username}}' fra gruppen '{{groupname}}'.",
        couldNotAddUserToGroup:
          "Kunne ikke legge til brukeren '{{username}}' i gruppen '{{groupname}}'.",
        couldNotGetAListOfUsersInGroup:
          "Kunne ikke hente liste over medlemmer i gruppen '{{groupname}}'.",
        couldNotGetAListOfAllUsers: 'Kunne ikke hente liste over alle brukere.',
      },
    },
    catalogApi: {
      couldNotGetAListOfAllFormDefinitionsForOrganizationID:
        "Kunne ikke hente liste med alle kataloger for organisasjon med ID '{{organizationID}}'.",
      listAllFormDefinitionsByOrganizationIDError:
        "listAllFormDefinitionsByOrganizationID: Kunne ikke hente liste med alle kataloger for organisasjon med ID '{{organizationID}}'.",
      couldNotGetAListOfCategoriesForFormDefinitionID:
        "Kunne ikke hente liste med alle kategorier for katalog med ID '{{formDefinitionID}}'.",
      couldNotGetAListOfQuestionsForCategoryID:
        "Kunne ikke hente liste med spørsmål for kategori med ID '{{categoryID}}'.",
      couldNotUpdateCategoryWithID:
        "Kunne ikke oppdatere kategori med ID '{{categoryID}}'",
      couldNotUpdateQuestionWithID:
        "Kunne ikke oppdatere spørsmål med ID '{{questionID}}'",
      couldNotUpdateFormDefinitionWithID:
        "Kunne ikke oppdatere katalog med ID '{{formDefinitionID}}'.",
      couldNotDeleteFormDefinitionWithID:
        "Kunne ikke slette katalog med ID '{{formDefinitionID}}'.",
      couldNotDeleteCategoryWithID:
        "Kunne ikke slette kategori med ID '{{categoryID}}'.",
      couldNotDeleteQuestionWithID:
        "Kunne ikke slette spørsmål med ID '{{questionID}}'.",
      couldNotCreateTheFormDefinition:
        "Kunne ikke opprette katalogen '{{catalogName}}'.",
      couldNotCreateTheCategory:
        "Kunne ikke opprette kategorien '{{categoryName}}'.",
      couldNotCreateTheQuestion:
        "Kunne ikke opprette spørsmålet '{{question}}'.",
    },
    groupsApi: {
      couldNotGetMembersOfGroupWithID:
        "Kunne ikke hente medlemmer av gruppen med ID '{{groupID}}'.",
      ...
      couldNotAddUserWithIDToGroupWithID:
        "Kunne ikke legge legge til brukeren med ID '{{userID}}' i gruppen med ID '{{groupID}}'.",
      couldNotUpdateUserWithIDToGroupWithID:
        "Kunne ikke oppdatere brukeren med ID '{{userID}}' til gruppen med ID '{{groupID}}'.",
      couldNotRemoveUserWithIDFromGroupWithID:
        "Kunne ikke fjerne brukeren med ID '{{userID}}' fra gruppen med ID '{{groupID}}'.",
      couldNotAddAGroup: 'Kunne ikke legge til gruppe.',
      couldNotRemoveGroupWithID:
        "Kunne ikke fjerne gruppen med ID '{{groupID}}'.",
      couldNotSetGroupLeaderToUsernameOnGroupWithID:
        "Kunne ikke sette gruppeleder til '{{username}}' for gruppen med ID '{{groupID}}'.",
    },
    superAdminApi: {
      couldNotGetAListOfOrganizations:
        'Kunne ikke hente en liste med organisasjoner.',
      couldNotAddTheOrganization:
        "Kunne ikke legge til organisasjonen '{{organizationName}}'.",
      couldNotDeleteTheOrganization:
        "Kunne ikke slette organisasjonen '{{organizationName}}'.",
      theNewOrganizationWasNotProperlyConfigured:
        "Den nye organisasjonen '{{organizationName}}' ble ikke konfigurert riktig.",
    },
    aria: {
