...
export const YourAnswersDesktop = ({ ...props }: YourAnswerProps) => {
  ...
  return (
    ...
    >
      <div
        className={
          props.activePanel === Panel.MyAnswers ? style.answerBox : style.hidden
        }
      >
        <div
          className={clsx(
        ...
        >
          <div className={style.catHeader}>
            <div className={style.blockInfo}>{props.activeCategory}</div>
        ...
        >
          <div className={style.formHeader}>
            ...
            />
            <h2 className={style.categoryTitle}>{props.activeCategory}</h2>
          </div>
