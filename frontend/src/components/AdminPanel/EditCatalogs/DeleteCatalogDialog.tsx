...
const DeleteCatalogDialog = ({ onCancel, onConfirm, onExited, open }: any) => {
  ...
  return (
    ...
    >
      ...
      <DialogContent>
        <DialogContentText>
          Er du sikker på at du har lyst å fjerne denne katalogen? Dette vil
          ikke slette svarene til de ansatte, men gjør det vanskelig å koble
          svar opp mot spørsmålsett.
        </DialogContentText>
      </DialogContent>
